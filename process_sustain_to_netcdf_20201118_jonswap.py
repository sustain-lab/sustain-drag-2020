...
start_time = datetime(2020, 11, 18, 17, 53)
...
ds.attrs['experiment_name'] = 'wind-with-jonswap_fresh-water_' + start_time.strftime('%Y%m%d')
ds.attrs['experiment_time'] = start_time.strftime('%Y-%m-%d_%H:%M:%S')
ds.attrs['water_type'] = 'fresh'
ds.attrs['jonswap_peak_frequency'] = 1
ds.attrs['jonswap_significant_wave_height'] = 0.1
ds.attrs['jonswap_directional_spreading'] = 'Yes, cos^2'
...
ds.to_netcdf('sustain_drag_' + start_time.strftime('%Y%m%d')  + '_jonswap.nc', 'w', 'NETCDF4')
